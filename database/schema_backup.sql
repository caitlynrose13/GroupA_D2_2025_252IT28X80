...
-- Comprehensive enterprise-grade schema with multi-tenancy support
...
-- Program cycles table (12-month program structure)
CREATE TABLE program_cycles (
    ...
    quiz_month INTEGER NOT NULL,
    is_active BOOLEAN DEFAULT 1,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Program months table (detailed month information)
CREATE TABLE program_months (
    ...
    is_active BOOLEAN DEFAULT 1,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (cycle_id) REFERENCES program_cycles(id)
);
...
CREATE TABLE content (
    ...
    FOREIGN KEY (month_id) REFERENCES program_months(id),
...
CREATE TABLE organization_analytics (
    ...
    FOREIGN KEY (organization_id) REFERENCES organizations(id),
    FOREIGN KEY (month_id) REFERENCES program_months(id),
    UNIQUE(organization_id, month_id)
);
...
CREATE INDEX idx_employee_progress_month ON employee_progress(month_id);
...
CREATE INDEX idx_org_analytics_month ON organization_analytics(month_id);
...
-- Insert program cycles (12-month structure)
INSERT INTO program_cycles (cycle_number, title, description, start_month, end_month, quiz_month) VALUES 
(1, 'Foundational Threats and Digital Hygiene', 'Building strong security foundations with threat awareness and digital hygiene practices', 1, 4, 4),
(2, 'POPIA and Data Protection', 'Understanding and implementing data protection compliance requirements', 5, 8, 8),
(3, 'Proactive Security and Advanced Threats', 'Advanced security practices and sophisticated threat response', 9, 12, 12);

-- Insert program months
INSERT INTO program_months (month_number, cycle_id, title, description, theme) VALUES 
(1, 1, 'Phishing and Social Engineering', 'Recognize and respond to phishing attacks and social engineering tactics', 'Threat Recognition'),
(2, 1, 'Password Management and Authentication', 'Strong password practices and multi-factor authentication setup', 'Authentication Security'),
(3, 1, 'Malware and Ransomware', 'Understanding malware threats and ransomware prevention', 'Malware Protection'),
(4, 1, 'Cycle 1 Assessment', 'Assessment of foundational security knowledge', 'Knowledge Assessment'),
(5, 2, 'POPIA Basics', 'Introduction to Protection of Personal Information Act requirements', 'Legal Compliance'),
(6, 2, 'Data Handling and Compliance', 'Proper data handling procedures and compliance practices', 'Data Management'),
(7, 2, 'Physical Security and Data Privacy', 'Physical security measures and data privacy protection', 'Physical Security'),
(8, 2, 'Cycle 2 Assessment', 'Assessment of POPIA and data protection knowledge', 'Knowledge Assessment'),
(9, 3, 'Business Email Compromise and Financial Fraud', 'Advanced threat recognition and response procedures', 'Advanced Threats'),
(10, 3, 'Secure Device and Network Usage', 'Advanced device security and network safety practices', 'Network Security'),
(11, 3, 'Insider Threats and Threat Reporting', 'Identifying insider threats and establishing reporting procedures', 'Threat Response'),
(12, 3, 'Cycle 3 Assessment', 'Assessment of advanced security knowledge and practices', 'Knowledge Assessment');